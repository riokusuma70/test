<template>
	<main class="antialiased">
		<audio class="hidden" id="audio" loop src="/audio/grow.mp3"></audio>
		...
		<ToolsRight />
		<ToolsLeft />
		<Navbar :brideSection="brideSection" :eventSection="eventSection" :gallerySection="gallerySection"  :wishSection="wishSection" />
	</main>
</template>
