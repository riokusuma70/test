globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file://D:/Internship/New%20folder/no-event/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file://D:/Internship/New%20folder/no-event/node_modules/std-env/dist/index.mjs';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, getRequestHeaders, setResponseHeader, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, readBody, getQuery, createError } from 'file://D:/Internship/New%20folder/no-event/node_modules/h3/dist/index.mjs';
import { PrismaClient } from 'file://D:/Internship/New%20folder/no-event/node_modules/@prisma/client/index.js';
import Pusher from 'file://D:/Internship/New%20folder/no-event/node_modules/pusher/lib/pusher.js';
import { createRenderer } from 'file://D:/Internship/New%20folder/no-event/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file://D:/Internship/New%20folder/no-event/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { parseURL, withoutBase, joinURL, withQuery } from 'file://D:/Internship/New%20folder/no-event/node_modules/ufo/dist/index.mjs';
import destr from 'file://D:/Internship/New%20folder/no-event/node_modules/destr/dist/index.mjs';
import { snakeCase } from 'file://D:/Internship/New%20folder/no-event/node_modules/scule/dist/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file://D:/Internship/New%20folder/no-event/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://D:/Internship/New%20folder/no-event/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://D:/Internship/New%20folder/no-event/node_modules/hookable/dist/index.mjs';
import { hash } from 'file://D:/Internship/New%20folder/no-event/node_modules/ohash/dist/index.mjs';
import { createStorage } from 'file://D:/Internship/New%20folder/no-event/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://D:/Internship/New%20folder/no-event/node_modules/unstorage/drivers/fs.mjs';
import defu from 'file://D:/Internship/New%20folder/no-event/node_modules/defu/dist/defu.mjs';
import { toRouteMatcher, createRouter } from 'file://D:/Internship/New%20folder/no-event/node_modules/radix3/dist/index.mjs';
import chalk from 'file://D:/Internship/New%20folder/no-event/node_modules/chalk/source/index.js';
import { HtmlValidate, formatterFactory } from 'file://D:/Internship/New%20folder/no-event/node_modules/html-validate/dist/es/index.js';

const _runtimeConfig = {"app":{"baseURL":"/","buildAssetsDir":"/_nuxt/","cdnURL":""},"nitro":{"envPrefix":"NUXT_","routeRules":{"/__nuxt_error":{"cache":false}}},"public":{"appURL":"","pusher":{"appId":"","key":"","secret":"","cluster":""}}};
...
const serverAssets = [{"baseName":"server","dir":"D:/Internship/New folder/no-event/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\Internship\\New folder\\no-event","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\Internship\\New folder\\no-event\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\Internship\\New folder\\no-event\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\Internship\\New folder\\no-event\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _yio2okrsKw = (function(nitro) {
...
const useChecker = (validator, usePrettier = false, logLevel = "verbose") => {
  ...
  const checkHTML = async (url, html) => {
    ...
    try {
      if (usePrettier) {
        const { format } = await import('file://D:/Internship/New%20folder/no-event/node_modules/prettier/index.js');
    ...
    const formatter = couldFormat ? formatterFactory("codeframe") : await import('file://D:/Internship/New%20folder/no-event/node_modules/@html-validate/stylish/dist/index.js').then((r) => r.default?.default ?? r.default ?? r);
...
const config$1 = {"usePrettier":false,"failOnError":false,"options":{"extends":["html-validate:document","html-validate:recommended","html-validate:standard"],"rules":{"svg-focusable":"off","no-unknown-elements":"error","void-style":"off","no-trailing-whitespace":"off","require-sri":"off","attribute-boolean-style":"off","doctype-style":"off","no-inline-style":"off"}},"logLevel":"verbose"};

const _cohLKYLRRX = (function(nitro) {
  const validator = getValidator(config$1.options);
  const { checkHTML } = useChecker(validator, config$1.usePrettier, config$1.logLevel);
...
const _lazy_coGjl4 = () => Promise.resolve().then(function () { return wish_post$1; });
const _lazy_TD7A5T = () => Promise.resolve().then(function () { return wish_get$1; });
const _lazy_GEeRnM = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/wish', handler: _lazy_coGjl4, lazy: true, middleware: false, method: "post" },
  { route: '/api/wish', handler: _lazy_TD7A5T, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy_GEeRnM, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_GEeRnM, lazy: true, middleware: false, method: undefined }
];
...
const wish_post = defineEventHandler(async (event) => {
  const data = await readBody(event);
  pusher.trigger("wish-channel", "wish-event", data);
  return await prisma$1.wish.create({ data });
});

const wish_post$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: wish_post
});

const prisma = new PrismaClient();
const wish_get = defineEventHandler(async () => {
  try {
...
const wish_get$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: wish_get
});
...
const getClientManifest = () => import('file://D:/Internship/New%20folder/no-event/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _virtual__headStatic = {"headTags":"<meta charset=\"utf-8\">\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">\n<meta name=\"robots\" content=\"index, follow\">\n<meta name=\"author\" content=\"Rio Kusuma\">\n<meta name=\"rating\" content=\"General\">\n<meta name=\"google\" content=\"notranslate\">\n<meta name=\"apple-mobile-web-app-capable\" content=\"yes\">\n<meta name=\"apple-mobile-web-app-status-bar-style\" content=\"black\">\n<meta name=\"format-detection\" content=\"telephone=no\">\n<meta name=\"msapplication-TileColor\" content=\"#FFFFFF\">\n<meta name=\"application-name\">\n<meta name=\"description\" content=\"undefined Page\">\n<meta property=\"og:description\" content=\"undefined Page\">\n<meta property=\"og:image\" content=\"undefined/images/wish.jpg\">\n<meta property=\"og:image:type\" content=\"image/jpg\">\n<meta property=\"og:locale\" content=\"id_ID\">\n<meta property=\"og:site:name\">\n<meta property=\"og:title\">\n<meta property=\"og:type\" content=\"website\">\n<meta property=\"og:url\">\n<meta property=\"twitter:card\" content=\"summary_large_image\">\n<meta property=\"twitter:description\" content=\"undefined Page\">\n<meta property=\"twitter:title\">\n<meta property=\"twitter:image\" content=\"undefined/images/wish.jpg\">\n<link rel=\"author\" href=\"https://github.com/rios70\">\n<link rel=\"icon\" href=\"/favicon.ico\">\n<link rel=\"shortcut icon\" href=\"/favicon.ico\">\n<link rel=\"apple-touch-icon\" href=\"/favicon/favicon-16x16.png\" sizes=\"16x16x\">\n<link rel=\"apple-touch-icon\" href=\"/favicon/favicon-32x32.png\" sizes=\"32x32\">\n<link rel=\"preload\" as=\"image\" href=\"/images/gallery4.jpg\">","bodyTags":"","bodyTagsOpen":"","htmlAttrs":" class=\"overflow-hidden\" lang=\"id\" translate=\"no\"","bodyAttrs":" class=\"relative overflow-hidden scroll-smooth scrollbar-thin scrollbar-track-gray-600 scrollbar-thumb-gray-200 scrollbar-track-rounded-full scrollbar-thumb-rounded-full dark:scrollbar-track-slate-800 dark:scrollbar-thumb-gray-100\""};
