<template>
	<section class="bg-cover bg-no-repeat text-center dark:bg-stone-200" style="background-image: url('/images/2.jpg')" id="gallery">
		<div class="w-full rounded-2xl bg-stone-400 p-10 dark:bg-stone-200">
		<div class="pt-12 md:pt-20">
			<h2 class="font-body text-5xl font-serif text-gray-200 dark:text-slate-600 md:text-7xl" data-aos="zoom-in" data-aos-duration="750">Moment Bahagia</h2>
		...
		<div class="mx-auto max-w-xs pb-20 md:max-w-2xl lg:max-w-4xl">
			...
			<div class="mt-5 grid grid-cols-2 gap-5 md:grid-cols-3 lg:grid-cols-6">
				...
				<div class="group relative overflow-hidden" v-for="(image, idx) in images" :key="idx" data-aos="flip-right" data-aos-duration="750" :data-aos-delay="(num += 100)" @click="() => show(idx)">
					...
					<div class="absolute inset-0 h-full w-full overflow-hidden bg-black/10 bg-fixed opacity-0 transition-opacity duration-300 group-hover:opacity-100" ></div>
				</div>
			</div>
		</div>
	</div>
...
<script setup lang="ts">
	...
	let num = 0;
	const images = ['/images/gallery2.jpg', '/images/gallery3.jpg', '/images/gallery4.jpg', '/images/gallery5.jpg', '/images/gallery6.jpg', '/images/gallery7.jpg', '/images/gallery8.jpg', '/images/gallery9.jpg', '/images/gallery10.jpg', '/images/gallery11.jpg', '/images/gallery12.jpg', '/images/gallery13.jpg'];
