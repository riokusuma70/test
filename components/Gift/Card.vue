<template>
	<div class="w-full rounded-2xl border border-gray-800 bg-white/80 p-8 dark:border-slate-800 md:w-96">
		...
		<div class="space-y-3 pt-3 md:pt-5">
			...
			<span class="block text-sm font-bold uppercase tracking-[0.3em] md:text-base">Rio Kusuma</span>
			<span class="block text-sm font-bold uppercase tracking-[0.3em] md:text-base">404 - 063 - 8798</span>
