<template>
	<section class="bg-cover bg-no-repeat text-center w-[screen] h-[screen]" style="background-image: url('/images/2.jpg')" id="wish">
		<div class="mx-auto max-w-xs py-12 md:max-w-2xl md:py-16 lg:max-w-4xl">
			<h2 class="text-center font-serif text-2xl uppercase tracking-widest text-yellow-800 dark:text-yellow-300/90 md:text-4xl " data-aos="zoom-in" data-aos-duration="750">Harapan & Do'a</h2>
			<h3 class="mt-4 mb-10 text-center font-serif text-sm italic text-slate-600 dark:text-brown-100 md:text-base" data-aos="zoom-in" data-aos-duration="750">Sampaikan do'a dan ucapan terbaik Anda untuk kedua mempelai.</h3>
