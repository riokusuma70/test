<template>
	<div class="relative top-0 left-0 z-50 h-screen w-screen bg-slate-800 bg-[url('/images/gallery2.jpg')] bg-cover bg-center bg-no-repeat " id="splash">
		<div class="absolute inset-0 -z-10 bg-black/40"></div>
		<div class="flex h-screen w-screen flex-col items-center justify-center gap-y-16">
			<div class="space-y-6 font-serif text-center md:space-y-14 lg:space-y-10">
				<h1 class="font-serif text-xl text-gray-100 md:text-4xl">Undangan Pernikahan</h1>
				<h2 class="font-body text-4xl text-yellow-300/90 md:text-7xl">Ivan & Virginia</h2>
			...
			<p class="absolute bottom-5 max-w-xs text-center text-xs font-semibold text-gray-100 md:max-w-full">
				Copyright &copy; 2023 <a class="font-bold hover:underline" href="https://github.com/rios70" target="_blank" rel="noopener noreferrer">Rio Kusuma</a> | All Rights Reserved
			</p>
		</div>
	</div>
</template>
